//
//  EKDemoNonReusedViewController.m
//  ExposureKitExample
//
...
#import "EKDemoNonReusedViewController.h"
#import "EKDemoNonReusedView.h"

#define column 4

@interface EKDemoNonReusedViewController ()
@property (nonatomic, strong) NSArray *testViews;
@end

@implementation EKDemoNonReusedViewController
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < 99; i++) {
        ...
        frames[index] = frame;
        EKDemoNonReusedView *view = [[EKDemoNonReusedView alloc] initWithFrame:frame];
...
{
    for (EKDemoNonReusedView *view in self.testViews) {
        [view reset];
    }
}
